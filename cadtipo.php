...
<body>
	...
	<form class="text-center" data-toggle="validator" action="controllertipo.php" method="post">

    	<div class="text-center"> 
        <br><h1>Cadastro de Tipo</h1>
        <a href="listtipo.php">Ver dados já cadastrados</a>
       </div>
